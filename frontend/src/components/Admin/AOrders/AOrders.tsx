...
import { cancelOrderAPI, convertTimeStringToDateObj, getOrdersAPI, sortOrdersByOrderTime } from "../../../services/ordersServices"
  ...
  return (
    <div className="order-list-item">
      <div className="order-details">
        <p className="customer-id">Customer ID: <strong>{orderItem.user}</strong></p>
